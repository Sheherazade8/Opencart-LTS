...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "assessment_attribute WHERE language_id = '" . (int)$this->config->get('config_language_id') . "'");

		foreach ($query->rows as $assessment_attribute) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "assessment_attribute SET assessment_id = '" . (int)$assessment_attribute['assessment_id'] . "', attribute_id = '" . (int)$assessment_attribute['attribute_id'] . "', language_id = '" . (int)$language_id . "', text = '" . $this->db->escape($assessment_attribute['text']) . "'");
		}
