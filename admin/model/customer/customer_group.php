...
class ModelCustomerCustomerGroup extends Model {
	...
	public function deleteCustomerGroup($customer_group_id) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "customer_group_description WHERE customer_group_id = '" . (int)$customer_group_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "assessment_discount WHERE customer_group_id = '" . (int)$customer_group_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "assessment_special WHERE customer_group_id = '" . (int)$customer_group_id . "'");
		$this->db->query("DELETE FROM " . DB_PREFIX . "assessment_reward WHERE customer_group_id = '" . (int)$customer_group_id . "'");
