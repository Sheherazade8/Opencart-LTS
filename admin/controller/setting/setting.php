...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_price'])) {
			$data['config_price'] = $this->request->post['config_price'];
		} else {
			$data['config_price'] = $this->config->get('config_price');
		}
		...
		if (isset($this->request->post['config_assessment_count'])) {
			$data['config_assessment_count'] = $this->request->post['config_assessment_count'];
		} else {
			$data['config_assessment_count'] = $this->config->get('config_assessment_count');
		}
