...
class ControllerCatalogReview extends Controller {
	...
	protected function getList() {
		...
		$data['sort_assessment'] = $this->url->link('catalog/review', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['assessment_id'])) {
			...
			$data['assessment_id'] = $review_info['assessment_id'];
		} else {
			$data['assessment_id'] = '';
		}
		...
		if (isset($this->request->post['assessment'])) {
			...
			$data['assessment'] = $review_info['assessment'];
		} else {
			$data['assessment'] = '';
		}
	...
	protected function validateForm() {
		...
		if (!$this->request->post['assessment_id']) {
