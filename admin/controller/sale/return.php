...
class ControllerSaleReturn extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if (isset($this->request->get['filter_assessment'])) {
				$url .= '&filter_assessment=' . urlencode(html_entity_decode($this->request->get['filter_assessment'], ENT_QUOTES, 'UTF-8'));
			}
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_assessment'])) {
			$filter_assessment = $this->request->get['filter_assessment'];
		} else {
			$filter_assessment = '';
		}
		...
		$data['sort_assessment'] = $this->url->link('sale/return', 'user_token=' . $this->session->data['user_token'] . '&sort=r.assessment' . $url, true);
		...
		$data['filter_assessment'] = $filter_assessment;
	...
	protected function getForm() {
		...
		if (isset($this->request->post['assessment_id'])) {
			...
			$data['assessment_id'] = $return_info['assessment_id'];
		} else {
			$data['assessment_id'] = '';
		}
