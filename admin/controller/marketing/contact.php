				...
				switch ($this->request->post['to']) {
					...
					case 'assessment':
						if (isset($this->request->post['assessment'])) {
							$email_total = $this->model_sale_order->getTotalEmailsByAssessmentsOrdered($this->request->post['assessment']);

							$results = $this->model_sale_order->getEmailsByAssessmentsOrdered($this->request->post['assessment'], ($page - 1) * 10, 10);
