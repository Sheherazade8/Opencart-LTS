...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/exam')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_exam'),
					'href'     => $this->url->link('catalog/exam', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'catalog/assessment')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_assessment'),
					'href'     => $this->url->link('catalog/assessment', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
