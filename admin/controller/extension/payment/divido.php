...
class ControllerExtensionPaymentDivido extends Controller {
	...
	public function index() {
		...
		$data['entry_assessments_options']= array(
			'all'		=> $this->language->get('entry_assessments_options_all'),
			'selected'	=> $this->language->get('entry_assessments_options_selected'),
			'threshold'	=> $this->language->get('entry_assessments_options_threshold'),
		);
		...
		if (isset($this->request->post['payment_divido_assessmentselection'])) {
			$data['payment_divido_assessmentselection'] = $this->request->post['payment_divido_assessmentselection'];
		} else {
			$data['payment_divido_assessmentselection'] = $this->config->get('payment_divido_assessmentselection');
		}
		...
		if (isset($this->request->post['payment_divido_exams'])) {
			$data['payment_divido_exams'] = $this->request->post['payment_divido_exams'];
		} elseif ($this->config->get('payment_divido_exams')) {
			$data['payment_divido_exams'] = $this->config->get('payment_divido_exams');
		} else {
			$data['payment_divido_exams'] = array();
		}
		...
		foreach ($data['payment_divido_exams'] as $exam_id) {
