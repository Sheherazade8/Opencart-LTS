...
class ControllerExtensionPaymentLaybuy extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_laybuy_exam'])) {
			$data['payment_laybuy_exam'] = $this->request->post['payment_laybuy_exam'];
		} elseif ($this->config->get('payment_laybuy_exam')) {
			$data['payment_laybuy_exam'] = $this->config->get('payment_laybuy_exam');
		} else {
			$data['payment_laybuy_exam'] = array();
		}
		...
		foreach ($data['payment_laybuy_exam'] as $exam_id) {
		...
		if (isset($this->request->post['payment_laybuy_xassessments'])) {
			$data['payment_laybuy_xassessments'] = $this->request->post['payment_laybuy_xassessments'];
		} else {
			$data['payment_laybuy_xassessments'] = $this->config->get('payment_laybuy_xassessments');
		}
