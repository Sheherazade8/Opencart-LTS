...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['theme_default_assessment_limit'])) {
			$data['theme_default_assessment_limit'] = $this->request->post['theme_default_assessment_limit'];
		} elseif (isset($setting_info['theme_default_assessment_limit'])) {
			$data['theme_default_assessment_limit'] = $setting_info['theme_default_assessment_limit'];
		} else {
			$data['theme_default_assessment_limit'] = 15;
		}		
		...
		if (isset($this->request->post['theme_default_assessment_description_length'])) {
			$data['theme_default_assessment_description_length'] = $this->request->post['theme_default_assessment_description_length'];
		} elseif (isset($setting_info['theme_default_assessment_description_length'])) {
			$data['theme_default_assessment_description_length'] = $setting_info['theme_default_assessment_description_length'];
		} else {
			$data['theme_default_assessment_description_length'] = 100;
		}
		
		if (isset($this->request->post['theme_default_image_exam_width'])) {
			$data['theme_default_image_exam_width'] = $this->request->post['theme_default_image_exam_width'];
		} elseif (isset($setting_info['theme_default_image_exam_width'])) {
			$data['theme_default_image_exam_width'] = $setting_info['theme_default_image_exam_width'];
		} else {
			$data['theme_default_image_exam_width'] = 80;		
		}
		
		if (isset($this->request->post['theme_default_image_exam_height'])) {
			$data['theme_default_image_exam_height'] = $this->request->post['theme_default_image_exam_height'];
		} elseif (isset($setting_info['theme_default_image_exam_height'])) {
			$data['theme_default_image_exam_height'] = $setting_info['theme_default_image_exam_height'];
		} else {
			$data['theme_default_image_exam_height'] = 80;
		}
		...
		if (isset($this->request->post['theme_default_image_assessment_width'])) {
			$data['theme_default_image_assessment_width'] = $this->request->post['theme_default_image_assessment_width'];
		} elseif (isset($setting_info['theme_default_image_assessment_width'])) {
			$data['theme_default_image_assessment_width'] = $setting_info['theme_default_image_assessment_width'];
		} else {
			$data['theme_default_image_assessment_width'] = 228;
		}
		
		if (isset($this->request->post['theme_default_image_assessment_height'])) {
			$data['theme_default_image_assessment_height'] = $this->request->post['theme_default_image_assessment_height'];
		} elseif (isset($setting_info['theme_default_image_assessment_height'])) {
			$data['theme_default_image_assessment_height'] = $setting_info['theme_default_image_assessment_height'];
		} else {
			$data['theme_default_image_assessment_height'] = 228;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_assessment_limit']) {
			$this->error['assessment_limit'] = $this->language->get('error_limit');
		}

		if (!$this->request->post['theme_default_assessment_description_length']) {
			$this->error['assessment_description_length'] = $this->language->get('error_limit');
		}

		if (!$this->request->post['theme_default_image_exam_width'] || !$this->request->post['theme_default_image_exam_height']) {
		...
		if (!$this->request->post['theme_default_image_assessment_width'] || !$this->request->post['theme_default_image_assessment_height']) {
