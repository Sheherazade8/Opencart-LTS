...
class ControllerDesignLayout extends Controller {
	...
	protected function validateDelete() {
		...
		foreach ($this->request->post['selected'] as $layout_id) {
			...
			$assessment_total = $this->model_catalog_assessment->getTotalAssessmentsByLayoutId($layout_id);

			if ($assessment_total) {
				$this->error['warning'] = sprintf($this->language->get('error_assessment'), $assessment_total);
			}

			$exam_total = $this->model_catalog_exam->getTotalExamsByLayoutId($layout_id);
