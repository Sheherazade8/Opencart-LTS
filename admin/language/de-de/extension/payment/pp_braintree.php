<?php
/**
 * @version		$Id: pp_braintree.php 6115 2021-03-14 10:15:06Z mic $
...
$_['text_pp_braintree']				= '<img src="view/image/payment/paypal-braintree.png" alt="PayPal (Powered by Braintree)" title="PayPal (Powered by Braintree)" style="border: 1px solid #EEEEEE;" width="94" />';
...
$_['text_braintree_learn']			= 'Um mit Kreditkarten und PayPal zu bezahlen <a href="https://www.braintreepayments.com/partners/learn-more" target="_blank">mehr dazu hier</a>';
$_['text_3ds']		 	 			= '3D Secure';
$_['text_cvv']		 	 			= 'CVV Nummer';
$_['text_promotion_main']			= 'Erstellt für Geschäfte aller Größen, einfache Zahlungsabwicklung um die Abwicklung zu maximieren und Kosten zu sparen - keine Setup- oder Monatsgebühren';
$_['text_promotion_li_1']			= 'Alle Vorteile von PayPal, plus Kreditkarten';
$_['text_promotion_li_2']			= 'Schnelle Einrichtung';
$_['text_promotion_li_3']			= 'Erreichung von PCI DSS v3.0 SAQ-A Compliance';
$_['text_promotion_li_4']			= 'Erlaubt Kunden mit Kreditkarten zu bezahlen';
...
// OC < 3.1
$_['text_braintree']				= '<img width="94" src="view/image/payment/paypal-braintree.png" alt="PayPal powered by Braintree" style="border: 1px solid #EEEEEE;">';
