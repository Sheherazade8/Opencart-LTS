...
$_['help_origin']                  = 'What origin point should be used (this setting affects only what UPS assessment names are shown to the user)';
...
$_['help_insurance']               = 'Enables insurance with assessment total as the value';
