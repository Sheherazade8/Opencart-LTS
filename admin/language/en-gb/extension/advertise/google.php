...
$_['heading_mapping']                       = 'Exam Mapping';
...
$_['step_mapping']                          = 'Exam Mapping';
$_['step_merchant_account']                 = 'Merchant Center Account';
$_['step_shipping_taxes']                   = 'Shipping &amp; Taxes';

// Help
$_['help_adult']                            = 'Use this attribute to indicate that individual assessments are for adults only because they contain adult content such as nudity, sexually suggestive content, or are intended to enhance sexual activity. Google cares what they show to their users, so if your business model is not adult oriented but you&apos;re selling an individual adult-oriented assessment, you need to label that assessment clearly so Google can show appropriate and legally compliant content to people shopping online.';
$_['help_age_group']                        = 'Use this attribute to set the demographic that your assessment is designed for. When you use this attribute, your ad can appear in results that are filtered by age. For example, if results are filtered by Women instead of Girls. The Age Group can also work together with the Gender to help ensure that users see the correct size information.';
...
$_['help_carrier_price_percentage']         = 'Estimate the shipment price as percentage of the assessment price.';
$_['help_color']                            = 'If the assessment a color option, select it here. This is a required attribute for all apparel items in feeds that target Brazil, France, Germany, Japan, the UK, and the US as well as all assessments available in different colors.';
$_['help_condition']                        = 'Tell users about the condition of the assessment you&apos;re selling. Setting this value correctly is important since Google uses it to refine search results.';
...
$_['help_gender']                           = 'Specify the gender your assessment is designed for using the gender attribute. When you provide this information, potential customers can accurately filter assessments by gender to help narrow their search. Keep in mind that Google also uses the gender information together with the values you provide for Size and Age Group to standardize the sizes that are shown to users.';
$_['help_google_assessment_exam']          = 'Use the this attribute to indicate the exam of your item based on the Google assessment taxonomy. Examizing your assessment helps ensure that your ad is shown with the right search results.';
$_['help_is_bundle']                        = 'Use the Bundle attribute to indicate that you&apos;ve created a bundle: a main assessment that you&apos;ve grouped with other, different assessments, sold together as one package for a single price. This attribute lets Google show your ad in the right situations by distinguishing your item from manufacturer-created bundles, multipacks, and other assessments without accessories.';
...
$_['help_multipack']                        = 'Use the Multipack attribute to indicate that you&apos;ve grouped multiple identical assessments for sale as one item. This attribute lets Google show your ad in the right situations by distinguishing your item from manufacturer-created multipacks, bundles, and other assessments.';
...
$_['help_size']                             = 'Use the size attribute to describe the standardized size of your assessment. When you use this attribute, your ad can appear in results that are filtered by size. The size you submit will also affect how your assessment variants are shown.';
$_['help_size_system']                      = 'With this attribute you can explain which country&apos;s sizing system your assessment uses. This information helps create accurate filters, which users can use to narrow search results. The sizing system that you submit will affect search, filtering, and how variants are shown in your ad.';
$_['help_size_type']                        = 'Use this attribute to describe the cut of your assessment. This information helps create accurate filters, which users can use to narrow search results.';
...
$_['entry_feed']                            = 'Assessment Feeds';
$_['entry_gender']                          = 'Gender';
$_['entry_google_assessment_exam']         = 'Google Assessment Exam';
...
$_['entry_oc_exam']                     = 'OpenCart Exam (autocomplete)';
$_['entry_roas']                            = 'ROAS';
...
$_['text_acknowledge_add_campaign_1']       = 'I acknowledge that my campaigns will not become active until my assessment feeds get approved according to the <a href="https://support.google.com/merchants/answer/6149970" target="_blank"><strong>Google Merchant Center requirements</strong></a>.';
...
$_['text_campaign_more_info']               = '<h4>Campaign Duration</h4><p>Campaigns will run until paused. You can pause a campaign at any time.</p><hr /><h4>Campaign Optimization</h4><p>It usually takes around 30 days for Google to rank assessments and optimize shopping ad campaigns.</p><hr /><h4>Assessments in Campaign</h4><p>Google will create a unique shopping ad for each approved assessment synced to your Merchant Center account. Ads are optimized based to maximize your sales. Popular assessments will likely receive more of your budget.</p><hr /><h4>Campaign Duration</h4><p>Campaigns will run until paused. You can pause a campaign at any time.</p><hr /><h4>Shopping Ad Placement</h4><p>Your ads may appear on multiple platforms including Google Search, Google Display Network, Youtube, and Gmail.</p>';
$_['text_campaigns']                        = 'Campaigns';
$_['text_carrier_postcode']                 = 'Origin Postal Code';
$_['text_carrier_price_percentage']         = 'Price Percentage';
$_['text_checklist_acknowledge_0']          = '<h4>Visibility of assessment catalog</h4><p>I confirm my assessment catalog is publically accessible without requiring a password.</p>';
...
$_['text_info_popup_assessment']               = 'The information requested here is required to properly list your assessment on Google Shopping. <a href="https://support.google.com/merchants/answer/7052112?hl=en&ref_topic=6324338" target="_blank">Click here</a> for more information.';
...
$_['text_mapping_intro']                    = 'Select your OpenCart exams which best match the pre-defined Google exams. This helps Google understand what you\'re selling so that they can better connect your ads with search queries from potential customers. If none of your exams match the list below, just click "Proceed" to skip this step.';
$_['text_mapping_verify_intro']             = 'Some of your assessments are already mapped to Google exams. Should the new mapping edit all current assessments, or should it apply only for your future assessments?';
$_['text_mapping_verify_title']             = 'Confirm New Mapping';
$_['text_maximum_five']                     = 'Maximum 5 campaigns can be selected. Leaving a campaign unticked will <strong>unassign</strong> the assessments from this campaign.';
...
$_['text_panel_heading_mapping']            = 'Step 5 of 5: Set up Exam Mapping';
$_['text_panel_heading_mapping_2']          = 'Set up Exam Mapping';
...
$_['text_popup_title_multiple']             = 'Editing %s assessments';
...
$_['text_tutorial_cron']                    = 'https://isenselabs.com/posts/how-to-auto-sync-opencart-assessments-with-google-shopping';
$_['text_usd']                              = 'USD';
...
// Tabs
$_['tab_text_ads']                          = 'Assessment Ads / Reports';
...
$_['button_apply']                          = 'Assign Selected Assessments to Campaigns';
...
$_['button_mapping']                        = 'Exam Mapping';
$_['button_proceed']                        = 'Proceed';
$_['button_assessment_edit']                   = 'Edit Google Fields';
$_['button_assessment_set']                    = 'Set Google Fields';
$_['button_save']                           = 'Save';
$_['button_save_future']                    = 'Save &amp; Do Nothing';
$_['button_save_modify']                    = 'Save &amp; Modify Current Assessments';
...
// Success
$_['success_advertise_disable']             = 'Success! Advertising has been disabled for the selected assessments!';
$_['success_advertise_enable']              = 'Success! Advertising has been enabled for the selected assessments!';
$_['success_advertise_listed']              = 'The shopping ads are live! If your assessments are not yet approved, please allow up to 3 business days for the Merchant Center team to review them.';
$_['success_advertise_unlisted']            = 'The shopping ads have been stopped. The assessments you edited no longer belong to any campaigns.';
...
$_['success_assessment']                       = 'Success! The assessment information has been updated.';
$_['success_shipping_taxes']                = 'Success! The merchant shipping and taxes have been updated.';
$_['success_target_add']                    = 'Success! Your new campaign has been created! It will become active as soon as your assessment feeds get approved by Google Merchant Center.';
...
$_['error_popup_not_found_body']            = 'The system could not find the assessment.';
...
$_['warning_no_advertised_assessments']        = 'No assessments are being advertised. To start advertising, you must assign assessments to campaigns. Follow <a href="%s" target="_blank"><strong>this tutorial</strong></a> to see how to do it.';
