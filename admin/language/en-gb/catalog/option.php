...
$_['error_assessment']      = 'Warning: This option cannot be deleted as it is currently assigned to %s assessments!';

// Nouveau code pour ajouter options à Exam

$_['error_exam']      = 'Warning: This option cannot be deleted as it is currently assigned to %s exams!';