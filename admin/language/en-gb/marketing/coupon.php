...
$_['help_exam']       = 'Choose all assessments under selected exam.';
$_['help_assessment']        = 'Choose specific assessments the coupon will apply to. Select no assessments to apply coupon to entire cart.';
