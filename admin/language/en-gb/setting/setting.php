...
$_['entry_assessment_count']            = 'Exam Assessment Count';
...
$_['help_assessment_count']             = 'Show the number of assessments inside the subexams in the storefront header exam menu. Be warned, this will cause an extreme performance hit for stores with a lot of subexams!';
...
$_['help_complete_status']           = 'Set the order status the customer\'s order must reach before they are allowed to access their downloadable assessments and gift vouchers.';
...
$_['help_stock_warning']             = 'Display out of stock message on the shopping cart page if a assessment is out of stock but stock checkout is yes. (Warning always shows if stock checkout is no)';
