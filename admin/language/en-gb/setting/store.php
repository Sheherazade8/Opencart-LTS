...
$_['help_checkout_guest']          = 'Allow customers to checkout without creating an account. This will not be available when a downloadable assessment is in the shopping cart.';
...
$_['help_stock_display']           = 'Display stock quantity on the assessment page.';
$_['help_stock_checkout']          = 'Allow customers to still checkout if the assessments they are ordering are not in stock.';
