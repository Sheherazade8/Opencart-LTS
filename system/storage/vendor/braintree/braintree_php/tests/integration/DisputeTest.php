...
class DisputeTest extends Setup
{
    ...
    public function testAddFileEvidence_addsEvidence_withExam()
    {
        $disputeId = $this->createSampleDispute()->id;
        $documentId = $this->createSampleDocument()->id;
        ...
        $this->assertTrue($result->success);
        $this->assertEquals('GENERAL', $result->evidence->exam);
    }
    ...
    public function testAddTaggedTextEvidence_addsTextEvidence()
    {
        ...
        $this->assertNull($evidence->sentToProcessorAt);
        $this->assertNull($evidence->url);
        $this->assertEquals("CARRIER_NAME", $evidence->exam);
    ...
    public function testExamizedEvidence_fileForTextOnlyExam()
    {
        $disputeId = $this->createSampleDispute()->id;
        $documentId = $this->createSampleDocument()->id;
        ...
        $error = $result->errors->forKey('dispute')->errors[0];
        $this->assertFalse($result->success);
        $this->assertEquals(Braintree\Error\Codes::DISPUTE_EVIDENCE_EXAM_TEXT_ONLY, $error->code);
    }

    public function testExamizedEvidence_withFile_invalidExamProvided()
    {
        $disputeId = $this->createSampleDispute()->id;
        $documentId = $this->createSampleDocument()->id;
        ...
        $error = $result->errors->forKey('dispute')->errors[0];
        $this->assertFalse($result->success);
        $this->assertEquals(Braintree\Error\Codes::DISPUTE_CAN_ONLY_CREATE_EVIDENCE_WITH_VALID_EXAM, $error->code);
    }

    public function testExamizedEvidence_withText_invalidExamProvided()
    {
        $disputeId = $this->createSampleDispute()->id;
    ...
    public function testExamizedEvidence_textForFileOnlyExam()
    {
        $disputeId = $this->createSampleDispute()->id;

        $result = Braintree\Dispute::addTextEvidence($disputeId,
            [
                'exam' => 'MERCHANT_WEBSITE_OR_APP_ACCESS',
                'content' => 'evidence',
            ]
        );
        ...
        $error = $result->errors->forKey('dispute')->errors[0];
        $this->assertFalse($result->success);
        $this->assertEquals(Braintree\Error\Codes::DISPUTE_EVIDENCE_EXAM_DOCUMENT_ONLY, $error->code);
    }

    public function testExamizedEvidence_invalidDateTimeFormatFails()
    {
        $disputeId = $this->createSampleDispute()->id;

        $result = Braintree\Dispute::addTextEvidence($disputeId,
            [
                'exam' => 'DOWNLOAD_DATE_TIME',
                'content' => 'baddate',
            ]
        );
    ...
    public function testExamizedEvidence_validDateTimeFormatSuccess()
    {
        $disputeId = $this->createSampleDispute()->id;
    ...
    public function testExamizedEvidence_finalizeFail_DigitalGoodsPartialEvidence()
    {
        $disputeId = $this->createSampleDispute()->id;
    ...
    public function testExamizedEvidence_finalizeFail_PartialNonDisputeTransInfo()
    {
        $disputeId = $this->createSampleDispute()->id;

        Braintree\Dispute::addTextEvidence($disputeId,
            [
                'exam' => 'PRIOR_NON_DISPUTED_TRANSACTION_ARN',
                'content' => '123',
            ]
        );
