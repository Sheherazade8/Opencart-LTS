...
class CreditCardTest extends Setup
{
    ...
    public function testPayrollCard()
    {
        ...
        $this->assertEquals('MSA', $result->creditCard->assessmentId);
    }
    ...
    public function testHealthCareCard()
    {
        ...
        $this->assertEquals('J3', $result->creditCard->assessmentId);
    }
    ...
    public function testNegativeCardTypeIndicators()
    {
        ...
        $this->assertEquals('MSB', $result->creditCard->assessmentId);
    }
    ...
    public function testUnknownCardTypeIndicators()
    {
        ...
        $this->assertEquals(Braintree\CreditCard::ASSESSMENT_ID_UNKNOWN, $result->creditCard->assessmentId);
    }
}
