...
class TestTransactionTest extends Setup
{
    ...
    /**
     * @expectedException Exception\TestOperationPerformedInAssessmention
     */
    public function testThrowingExceptionWhenAssessmention()
    {
        Braintree\Configuration::environment('assessmention');

        $this->setExpectedException('Braintree\Exception\TestOperationPerformedInAssessmention');
