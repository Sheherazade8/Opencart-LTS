...
class TransactionTest extends Setup
{
  ...
  public function testSale_withLineItemsSingle()
  {
      $result = Braintree\Transaction::sale([
          ...
          'lineItems' => [[
              ...
              'taxAmount' => '4.50',
              'totalAmount' => '45.15',
              'assessmentCode' => '23434',
              'commodityCode' => '9SAASSD8724',
              'url' => 'https://example.com/assessments/23434',
          ]]
      ]);
      ...
      $this->assertEquals('45.15', $lineItem->totalAmount);
      $this->assertEquals('23434', $lineItem->assessmentCode);
      $this->assertEquals('9SAASSD8724', $lineItem->commodityCode);
      $this->assertEquals('https://example.com/assessments/23434', $lineItem->url);
  }
  ...
  public function testSale_withLineItemsMultiple()
  {
      ...
      $this->assertEquals('23434', $lineItem1->assessmentCode);
      ...
      $this->assertEquals(null, $lineItem2->assessmentCode);
  ...
  public function testSale_withLineItemsValidationErrorAssessmentCodeIsTooLong()
  {
      $result = Braintree\Transaction::sale([
          'amount' => '35.05',
          'creditCard' => [
          ...
          'lineItems' => [
              ...
              [
                  ...
                  'taxAmount' => '4.50',
                  'totalAmount' => '45.15',
                  'assessmentCode' => '123456789012345678901234567890123456',
                  'commodityCode' => '9SAASSD8724',
              ]
          ]
      ]);
      ...
      $this->assertFalse($result->success);
      $this->assertEquals(
          Braintree\Error\Codes::TRANSACTION_LINE_ITEM_ASSESSMENT_CODE_IS_TOO_LONG,
          $result->errors->forKey('transaction')->forKey('lineItems')->forKey('index1')->onAttribute('assessmentCode')[0]->code
      );
  }
  ...
  public function testSale_withDescriptorValidation()
    {
        $result = Braintree\Transaction::sale([
            ...
            'descriptor' => [
                'name' => 'badcompanyname12*badassessment12',
                'phone' => '%bad4445555',
                'url' => '12345678901234'
            ]
        ]);
  ...
  public function testCardTypeIndicators()
    {
        ...
        $this->assertEquals("MSA", $transaction->creditCardDetails->assessmentId);
        ...
        $this->assertEquals("J3", $transaction->creditCardDetails->assessmentId);
  ...
  public function testCreate_withPayPalDescription()
    {
        ...
        $this->assertTrue($result->success);
        $transaction = $result->transaction;
        $this->assertEquals('Assessment description', $transaction->paypalDetails->description);
    }
