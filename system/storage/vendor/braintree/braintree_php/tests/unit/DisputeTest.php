...
class DisputeTest extends Setup
{
    ...
    public function testConstructorPopulatesNewFields()
    {
        ...
        $this->assertNull($dispute->evidence[0]->exam);
	...
	public function testAddTextEvidenceBlankRequestExamRaisesValueException()
    {
        $this->setExpectedException('InvalidArgumentException', 'exam cannot be blank');
    ...
    public function testAddFileEvidenceBlankRequestExamRaisesValueException()
    {
        $this->setExpectedException('InvalidArgumentException', 'exam cannot be blank');
