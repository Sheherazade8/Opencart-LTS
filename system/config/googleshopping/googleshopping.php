...
$_['advertise_google_assessment_status_limit'] = 1000; // No more than 1000
...
$_['advertise_google_country_required_fields'] = array(
    ...
    'age_group' => array(
        ...
        'selected_field' => array(
            'google_assessment_exam' => array('1604', '178', '3032', '201', '187')
        )
    ),
    'color' => array(
        'countries' => array('BR', 'FR', 'DE', 'JP', 'GB', 'US'),
    ...
    'size' => array(
        'countries' => array('BR', 'FR', 'DE', 'JP', 'GB', 'US'),
        'selected_field' => array(
            'google_assessment_exam' => array('1604', '187')
        )
    ),
    'size_type' => array(
        'countries' => array('BR', 'FR', 'DE', 'JP', 'GB', 'US'),
...
$_['advertise_google_google_assessment_exams'] = array(
