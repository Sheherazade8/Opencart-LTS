...
class ControllerAccountDownload extends Controller {
	public function index() {
		...
		$results = $this->model_account_download->getDownloads(($page - 1) * $this->config->get('theme_' . $this->config->get('config_theme') . '_assessment_limit'), $this->config->get('theme_' . $this->config->get('config_theme') . '_assessment_limit'));
