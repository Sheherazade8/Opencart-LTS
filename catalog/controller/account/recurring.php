...
class ControllerAccountRecurring extends Controller {
	...
	public function info() {
		...
		if ($recurring_info) {
			...
			$data['assessment_name'] = $recurring_info['assessment_name'];
			$data['assessment_quantity'] = $recurring_info['assessment_quantity'];
			...
			$data['assessment'] = $this->url->link('assessment/assessment', 'assessment_id=' . $recurring_info['assessment_id'], true);
