		...
		if (isset($this->request->get['_route_'])) {
			...
			foreach ($parts as $part) {
				...
				if ($query->num_rows) {
					...
					if ($url[0] == 'assessment_id') {
						$this->request->get['assessment_id'] = $url[1];
					}
					...
					if ($query->row['query'] && $url[0] != 'information_id' && $url[0] != 'manufacturer_id' && $url[0] != 'exam_id' && $url[0] != 'assessment_id') {
			...
			if (!isset($this->request->get['route'])) {
				if (isset($this->request->get['assessment_id'])) {
					$this->request->get['route'] = 'assessment/assessment';
				} elseif (isset($this->request->get['path'])) {
					$this->request->get['route'] = 'assessment/exam';
				} elseif (isset($this->request->get['manufacturer_id'])) {
					$this->request->get['route'] = 'assessment/manufacturer/info';
