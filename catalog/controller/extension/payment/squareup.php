    ...
    public function checkout() {
        ...
        try {
            ...
            $transaction_data = array(
                ...
                'delay_capture' => !$this->cart->hasRecurringAssessments() && $this->config->get('payment_squareup_delay_capture'),
            ...
            if ($order_status_id) {
                if ($this->cart->hasRecurringAssessments() && $transaction_status == 'captured') {
                    foreach ($this->cart->getRecurringAssessments() as $item) {
