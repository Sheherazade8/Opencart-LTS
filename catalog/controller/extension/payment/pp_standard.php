	...
	public function index() {
		...
		if ($order_info) {
			...
			foreach ($this->cart->getAssessments() as $assessment) {
				...
				$data['assessments'][] = array(
					'name'     => htmlspecialchars($assessment['name']),
					'model'    => htmlspecialchars($assessment['model']),
					'price'    => $this->currency->format($assessment['price'], $order_info['currency_code'], false, false),
