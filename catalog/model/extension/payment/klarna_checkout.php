...
class ModelExtensionPaymentKlarnaCheckout extends Model {
	...
	public function checkForPaymentTaxes($assessments = array()) {
		foreach ($assessments as $assessment) {
			$query = $this->db->query("SELECT COUNT(*) AS `total` FROM " . DB_PREFIX . "tax_rule WHERE `based` = 'payment' AND `tax_class_id` = '" . (int)$assessment['tax_class_id'] . "'");
