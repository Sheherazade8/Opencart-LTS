    ...
    public function makeOrder() {
        ...
        foreach ($this->cart->getAssessments() as $assessment) {
            ...
            $order_data['assessments'][] = array(
                ...
                'text_price' => $this->currency->format($assessment['price'], $this->session->data['currency']),
                'total'      => $assessment['total'],
                'text_total' => $this->currency->format($assessment['total'], $this->session->data['currency']),
