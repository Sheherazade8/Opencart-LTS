    ...
    public function nextRecurringPayments() {
        ...
        foreach ($this->db->query($recurring_sql)->rows as $recurring) {
            ...
            $transaction = array(
                ...
                'amount_money' => array(
                    'amount' => $this->squareup->lowestDenomination($price * $recurring['assessment_quantity'], $recurring['transaction_currency']),
